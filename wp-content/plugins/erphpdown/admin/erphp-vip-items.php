...
<div class="wrap">
	...
	<form method="get"><input type="hidden" name="page" value="erphpdown/admin/erphp-vip-items.php"><input type="text" name="username" placeholder="登录名，例如：admin" value="<?php if($issearch) echo $_GET['username'];?>"><input type="submit" value="查询" class="button"></form>
	<p>筛选：
